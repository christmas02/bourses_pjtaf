                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 30px; text-align: center;">
                                                    ...
                                                    <h3>Mise à jour de votre dossier de candidature</h3>

                                                    <p>
                                                        Nous vous informons que votre compte ainsi que votre dossier de candidature ont été
                                                        <strong>mis à jour avec succès</strong>.
                                                    </p>

                                                    <p>
                                                        La plateforme de candidature demeure <strong>ouverte durant toute la période officielle</strong>.
                                                        Vous pouvez donc vous connecter à votre espace personnel à tout moment afin de
                                                        compléter ou modifier vos informations si nécessaire.
                                                    </p>
                                                    <p>
                                                        Pour toute question ou besoin d’assistance, n’hésitez pas à nous contacter à l’adresse
