                            ...
                            <tr>
                                <td>
                                    <table style="margin: 0 auto; margin-bottom: 30px;">
                                        <tbody>
                                            <tr class="logo-sec" style="width: 100%; text-align: center;">
                                                <td>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 30px; text-align: center;">
                                                    ...
                                                    <img class="img-fluid for-light" src="{{ asset('/assets/images/gif/dashboard-8/successful.gif') }}" alt="" style="width: 15%; display: block; margin-left: auto; margin-right: auto;">
                                                    <h3>Votre compte et votre dossier ont été créés avec succès.</h3>

                                                    <p>
                                                        Un e-mail de confirmation vous a été envoyé à votre adresse électronique.
                                                        Veuillez cliquer sur le lien d’activation afin de finaliser l’ouverture de votre compte.
                                                        Une fois l’activation effectuée, vous serez automatiquement redirigé vers l’espace de connexion.
                                                    </p>

                                                    <p>
                                                        Veuillez ensuite accéder à votre espace personnel afin de procéder à la mise à jour de vos données de candidature, en cas d’informations manquantes.
                                                    </p>

                                                    <p>
                                                        Si vous ne recevez pas l’e-mail de confirmation dans les prochaines minutes,
                                                        veuillez vérifier votre dossier de courriers indésirables (spam).
                                                    </p>
                                                    ...
                                                    <p><br>
                                                        <a href="/" class="btn btn-primary btn-next" style="background-color: #006666; color: #fff; display: inline-block;
